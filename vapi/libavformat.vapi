namespace Av.Format
{
    ...
    [Compact, CCode (cname = "AVIOContext", free_function = "avio_close", cheader_filename = "libavformat/avio.h")]
    public class AVIOContext
    {
        [Flags, CCode (cname = "int", cprefix = "AVIO_FLAG_")]
        public enum Flag
        {
            READ,
            WRITE,
        ...
        [CCode (cname = "avio_open")]
        public static int open (out unowned AVIOContext context, string filename, Flag flags);
        [CCode (cname = "avio_closep")]
        public static int closep (ref unowned AVIOContext context);
    }
